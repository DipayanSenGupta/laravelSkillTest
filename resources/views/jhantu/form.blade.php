...
@section('content')
    <div class="container">
        <div class="col-md-8 offset-md-2">
            ...
            <hr/>
            @if(isset($image))
                {!! Form::model($image,['method'=>'put','files'=>true,'route' => ['jhantu.update', $image->id]]) !!}
            @else
                {!! Form::open(['route' => 'jhantu.store','files'=>true]) !!}
            @endif
            <div class="form-group row">
                {!! Form::label("image","Image",["class"=>"col-form-label col-md-3"]) !!}
                <div class="col-md-5">
                    <img id="preview"
                         src="{{asset((isset($image) && $image->image!='')?'images/'.$image->image:'images/noimage.jpg')}}"
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <a href="{{url('jhantu')}}" class="btn btn-danger">
                        Back</a>
...
@section('js')
    <script>
        ...
        $('#image').change(function () {
            ...
            if (ext == "gif" || ext == "png" || ext == "jpg" || ext == "jpeg" || ext == "webm"|| ext == "webp" )
                readURL(this);
            else
                alert("Please select image file (jpg, jpeg, png, webm, webp).")
        });
